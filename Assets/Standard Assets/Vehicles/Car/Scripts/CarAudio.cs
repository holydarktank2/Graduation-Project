...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade*accFade*PlayerPrefs.GetFloat("enginevolume");
                    m_LowDecel.volume = lowFade*decFade*PlayerPrefs.GetFloat("enginevolume");
                    m_HighAccel.volume = highFade*accFade*PlayerPrefs.GetFloat("enginevolume");
                    m_HighDecel.volume = highFade*decFade*PlayerPrefs.GetFloat("enginevolume");
        ...
        private AudioSource SetUpEngineAudioSource(AudioClip clip)
        {
           ...
           // AudioMixer mixer = SettingMenu.audioMixer;
            source.clip = clip;
