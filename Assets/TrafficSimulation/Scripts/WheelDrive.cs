    ...
    public class WheelDrive : MonoBehaviour
    {
        ...
        void OnEnable(){
            ...
            for (int i = 0; i < wheels.Length; ++i) 
            {
                ...
                if (leftWheelShape != null && wheel.transform.localPosition.x < 0 && wheel.transform.childCount == 0)
                {
                    var ws = Instantiate (leftWheelShape);
                    ws.transform.parent = wheel.transform;
                }
                else if(rightWheelShape != null && wheel.transform.localPosition.x > 0 && wheel.transform.childCount == 0)
                {
